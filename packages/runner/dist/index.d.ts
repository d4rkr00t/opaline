...
export declare type Task<Ctx = any, Params = any> = {
    ...
    abort?: (sharedCtx: Ctx, taskParams: Params, taskWrapper: TaskWrapper) => Promise<boolean>;
    skip?: (sharedCtx: Ctx, taskParams: Params, taskWrapper: TaskWrapper) => Promise<boolean>;
    task: (sharedCtx: Ctx, taskParams: Params, taskWrapper: TaskWrapper) => Promise<PrintableOutput | undefined | void>;
};
...
export declare class TaskWrapper<C = any, P = any> {
    ...
    format(text: PrintableOutput, formatter?: (text: string) => string): PrintableOutput;
...
export declare function createCommand<C, P>(tasks: Array<Task<C, P>>): (params: P) => Promise<void>;
